...
class CPDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        clip_ref_image = self.clip_image_processor(images=ref_image, return_tensors="pt").pixel_values
        ...
        result = {
            ...
            "pixel_values_ref_img": ref_image,
            "clip_ref_image": clip_ref_image,
            "warp_feat": feat,
...
if __name__ == "__main__":
    dataset = CPDataset("/workspace/groot/vton/VITON-HD", 512, mode="train", unpaired=False, clip_model_path="./pretrained_models/clip-vit-base-patch32")
