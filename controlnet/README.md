...
accelerate launch train_controlnet_orig.py  --pretrained_model_name_or_path="runwayml/stable-diffusion-v1-5"  --output_dir="output"   --dataset_name=fusing/fill50k  --resolution=512  --learning_rate=1e-5  --validation_image "./00008_00.jpg" --validation_image_garm "./00006_00.jpg"  --validation_prompt "levi's t - shirt with logo print, white-space-surrounding, wlop : :, k-pop, listing image, white borders, cartoonish and simplistic, feminine looking, is essentially arbitrary, levers, right align, ad image, white: 0.5, manuka, whealan, contest, stylised, f 1"  --train_batch_size=15 --num_train_epochs=40  --report_to=wandb   --validation_steps=50 --dataroot=./data/VITON-HD
