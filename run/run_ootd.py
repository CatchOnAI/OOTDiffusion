...
parser.add_argument('--model_path', type=str, default="/workspace/OOTDiffusion/data/VITON-HD/test/image/00008_00.jpg", required=False)
parser.add_argument('--cloth_path', type=str, default="/workspace/OOTDiffusion/data/VITON-HD/test/cloth/00008_00.jpg", required=False)
